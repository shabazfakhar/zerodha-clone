    ...
    for (let stock of allHoldings) {
      ...
      try {
        ...
        const response = await axios.get(
          `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${stock.name}.NSE&apikey=${process.env.REACT_APP_ALPHA_KEY}`
        );
        ...
        if (livePrice) {
          prices[stock.name] = parseFloat(livePrice);
        }
